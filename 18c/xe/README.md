...
-d izone/oracle:18.4.0-xe

docker logs -f Oracle
```
#### Access database
```
docker exec -ti OracleXE sqlplus sys/oracle@localhost/xe as sysdba
```
...
wget -c https://download.oracle.com/otn-pub/otn_software/db-express/oracle-database-xe-18c-1.0-1.x86_64.rpm -O files/oracle-database-xe-18c-1.0-1.x86_64.rpm
```
#### Build image
```
docker build -t izone/oracle:18.4.0-xe .
```
